...
import { LoginPageMap } from '../fixtures/elements/LoginPageMap'
const loginElements = new LoginPageMap
// var redirect_url=""
describe('Smoke Tests', () => {
  ...
  it('Login inválido', () => {
    ...
    cy.get(loginElements.loginBtn).should('be.visible')
    cy.get(loginElements.loginBtn).click()
    cy.get(loginElements.alertText).should("contain.text", "Usuário ou Senha inválidos")
  })
